...
mkdir -p Plugins-File-Extension-Lists/{Images,Code,Documents,Compressed,Media,Fonts,Other}
...
}
{
  ...
  if (ext == "" || ext ~ /^[0-9]+$/ || ext ~ /^[0-9]+\.[0-9]+$/ || ext ~ /^[0-9]+\.[0-9]+\.[0-9]+$/) {
    print $0 > "Plugins-File-Extension-Lists/all_no_extension_files_plugins.txt"
    next
  }
  if (full_path ~ /\.nfs(\.[0-9]{8}\.[0-9]{4})?$/) {
    print $0 > "Plugins-File-Extension-Lists/Other/all_nfs_extension_files_plugins.txt"
    next
  }
  if (full_path ~ /\.goutputstream-[a-zA-Z0-9]{6}(-[a-zA-Z0-9]{6})?$/) {
    print $0 > "Plugins-File-Extension-Lists/Other/all_goutputstream_extension_files_plugins.txt"
    next
  }
  if (full_path ~ /\.attach_pid[0-9]+?$/) {
    print $0 > "Plugins-File-Extension-Lists/Other/all_attach_extension_files_plugins.txt"
    next
  }
  if (full_path ~ /\.lock~[a-f0-9]{40}$/) {
    print $0 > "Plugins-File-Extension-Lists/Other/all_lock_extension_files_plugins.txt"
    next
  }
  if (full_path ~ /\.png[-_a-zA-Z0-9~@#$%^&*()+={}\[\]|;:,<>?]+$/) {
    print $0 > "Plugins-File-Extension-Lists/Images/all_png_extension_files_plugins.txt"
    next
  }
  if (ext == "save") {
    print $0 > "Plugins-File-Extension-Lists/Other/all_save_extension_files_plugins.txt"
    next
  }
  if (ext == "import") {
    print $0 > "Plugins-File-Extension-Lists/Other/all_import_extension_files_plugins.txt"
    next
  }
  if (ext == "mine") {
    print $0 > "Plugins-File-Extension-Lists/Other/all_mine_extension_files_plugins.txt"
    next
  }
  if (ext == "invalid") {
    print $0 > "Plugins-File-Extension-Lists/Other/all_invalid_extension_files_plugins.txt"
    next
  }
  if (ext == "br") {
    print $0 > "Plugins-File-Extension-Lists/Code/all_br_extension_files_plugins.txt"
    next
  }
  if (ext == "demo") {
    print $0 > "Plugins-File-Extension-Lists/Code/all_demo_extension_files_plugins.txt"
    next
  }
  if (ext == "orig") {
    print $0 > "Plugins-File-Extension-Lists/Other/all_orig_extension_files_plugins.txt"
    next
  }
  if (ext == "flow") {
    print $0 > "Plugins-File-Extension-Lists/Code/all_flow_extension_files_plugins.txt"
    next
  }
  if (ext == "guess") {
    print $0 > "Plugins-File-Extension-Lists/Other/all_guess_extension_files_plugins.txt"
    next
  }
  if (ext == "patched") {
    print $0 > "Plugins-File-Extension-Lists/Code/all_patched_extension_files_plugins.txt"
    next
  }
  if (full_path ~ /\.vpp~[0-9]+$/) {
    print $0 > "Plugins-File-Extension-Lists/Other/all_vpp_extension_files_plugins.txt"
    next
  }
  if (ext == "zip~") {
    print $0 > "Plugins-File-Extension-Lists/Compressed/all_zip_extension_files_plugins.txt"
    next
  }
  if (ext in images) {
    print $0 > "Plugins-File-Extension-Lists/Images/all_" ext "_extension_files_plugins.txt"
    next
  }
  if (ext in code) {
    print $0 > "Plugins-File-Extension-Lists/Code/all_" ext "_extension_files_plugins.txt"
    next
  }
  if (ext in documents) {
    print $0 > "Plugins-File-Extension-Lists/Documents/all_" ext "_extension_files_plugins.txt"
    next
  }
  if (ext in compressed) {
    print $0 > "Plugins-File-Extension-Lists/Compressed/all_" ext "_extension_files_plugins.txt"
    next
  }
  if (ext in media) {
    print $0 > "Plugins-File-Extension-Lists/Media/all_" ext "_extension_files_plugins.txt"
    next
  }
  if (ext in fonts) {
    print $0 > "Plugins-File-Extension-Lists/Fonts/all_" ext "_extension_files_plugins.txt"
    next
  }
  if (ext in other) {
    print $0 > "Plugins-File-Extension-Lists/Other/all_" ext "_extension_files_plugins.txt"
    next
  }
  print $0 > "Plugins-File-Extension-Lists/Other/all_unknown_extension_files_plugins.txt"
}' all_files_plugins.txt